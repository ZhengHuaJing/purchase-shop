...
import com.purchase.purchasegoods.entity.Template;
import com.purchase.purchasegoods.service.TemplateService;
...
public class TemplateController {
    ...
    @PutMapping("/{id}")
    public Result updateTemplate(@PathVariable(name = "id") Integer id, @Valid @RequestBody Template template) {
        template.setId(id);
    ...
    public Result listTemplateQueryPage(@RequestBody @Valid Template template, @PathVariable Integer page, @PathVariable Integer size) {
    ...
    @PostMapping("/search")
    public Result ListTemplateQuery(@RequestBody @Valid Template template) {
