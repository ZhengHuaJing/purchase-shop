...
import com.purchase.purchasegoods.entity.Spec;
import com.purchase.purchasegoods.service.SpecService;
...
public class SpecController {
    ...
    @PutMapping("/{id}")
    public Result updateSpec(@PathVariable(name = "id") Integer id, @Valid @RequestBody Spec spec) {
        spec.setId(id);
    ...
    public Result listSpecQueryPage(@RequestBody @Valid Spec spec, @PathVariable Integer page, @PathVariable Integer size) {
    ...
    @PostMapping("/search")
    public Result ListSpecQuery(@RequestBody @Valid Spec spec) {
