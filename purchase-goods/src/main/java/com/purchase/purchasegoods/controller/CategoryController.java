...
public class CategoryController {
    ...
    @PutMapping("/{id}")
    public Result updateCategory(@PathVariable(name = "id") Integer id, @Valid @RequestBody Category category) {
        category.setId(id);
    ...
    public Result listCategoryQueryPage(@RequestBody @Valid Category category, @PathVariable Integer page, @PathVariable Integer size) {
    ...
    @PostMapping("/search")
    public Result ListCategoryQuery(@RequestBody @Valid Category category) {
