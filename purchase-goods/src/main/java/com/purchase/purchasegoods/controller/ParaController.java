...
import com.purchase.purchasegoods.entity.Para;
import com.purchase.purchasegoods.service.ParaService;
...
public class ParaController {
    ...
    @PutMapping("/{id}")
    public Result updatePara(@PathVariable(name = "id") Integer id, @Valid @RequestBody Para para) {
        para.setId(id);
    ...
    public Result listParaQueryPage(@RequestBody @Valid Para para, @PathVariable Integer page, @PathVariable Integer size) {
    ...
    @PostMapping("/search")
    public Result ListParaQuery(@RequestBody @Valid Para para) {
