...
import com.purchase.purchaseservicegoods.service.AlbumService;
...
public class AlbumController {
    ...
    @PutMapping("/{id}")
    public Result updateAlbum(@PathVariable(name = "id") Long id, @RequestBody Album album) {
        album.setId(id);
    ...
    public Result listAlbumQueryPage(@RequestBody Album album, @PathVariable Integer page, @PathVariable Integer size) {
    ...
    @PostMapping("/search")
    public Result ListAlbumQuery(@RequestBody Album album) {
