...
import com.purchase.purchaseservicegoods.service.SkuService;
...
public class SkuController {
    ...
    @PutMapping("/{id}")
    public Result updateSku(@PathVariable(name = "id") String id, @RequestBody Sku sku) {
        sku.setId(id);
    ...
    public Result listSkuQueryPage(@RequestBody Sku sku, @PathVariable Integer page, @PathVariable Integer size) {
    ...
    @PostMapping("/search")
    public Result ListSkuQuery(@RequestBody Sku sku) {
